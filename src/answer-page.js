...
function renderQuestion() {
    ...
    questions.forEach((question, index) => {
        const { questionTag, options: { optionA, optionB, optionC, optionD }, optionId: { optionAId, optionBId, optionCId, optionDId }, choice, answerId, feedback, id, } = question;
        if (choice) {
            if (choice === answerId) {
                html += `
    <div class="question-container js-question-container">
          <div class="question-number"><p>Question ${index + 1} / ${totalQuestion}</p></div>
