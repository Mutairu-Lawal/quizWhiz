import {comments} from '../old-data/utils/comments'
...
function renderQuestion() {
  ...
  questionContainer.innerHTML = `<div class="display section min-sec">
          <div class="info">
            <h3>${quizType}</h3>
            <div class="page-no">
...
function renderResult() {
  ...
  (_a = document.querySelector('button')) === null || _a === void 0
    ? void 0
...
function getAllOptions() {
  ...
  options.forEach((option) => {
    const currentOption = option.querySelector;
